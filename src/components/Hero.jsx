function Hero() {
    return (
        <div className="max-w-4xl min-h-screen flex flex-col justify-center px-8 mx-auto">
            ...
            <div className="font-dm-sans text-gray-400 text-lg max-w-lg mb-10">BCA student at MDU Faridabad, building clean and user-focused interfaces. Currently learning React — already shipping.</div>
            <div className="flex gap-4">
                <a href="#projects" className=" font-dm-sans bg-[#c8f135] px-7 py-3 rounded-full text-sm">View my work</a>
                <a href="#contact" className="font-dm-sans border border-[#444] px-7 py-3 rounded-full text-sm text-white">Get in touch</a>
            </div>
        </div>
    )
}
