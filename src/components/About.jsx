function About() {
  return (
    <div className="max-w-4xl mx-auto px-8 py-24 scroll-m-40" id="about">
      ...
      <h1 className="text-4xl md:text-5xl text-white font-syne mb-12 leading-tight">
        A developer who loves to build.
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        <div>
          <div className="text-gray-500 text-base leading-relaxed mb-5">
            I'm a <span className="text-white">BCA student at MDU</span> . I got
            into frontend development because I enjoy building things that
            people actually use and interact with.
          </div>
          <div className="text-gray-500 text-base leading-relaxed mb-5">
            I build with{" "}
